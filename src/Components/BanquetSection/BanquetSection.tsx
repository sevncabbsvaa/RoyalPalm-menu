...
import type { BanquetSectionData, Language } from "../../types/menu";

type BanquetSectionProps = {
  section: BanquetSectionData;
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="mx-auto block w-full max-w-2xl overflow-hidden rounded-2xl border border-gold-500/20 bg-palm-800/40 shadow-lg transition hover:border-gold-500/40"
